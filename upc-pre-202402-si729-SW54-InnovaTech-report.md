...
|--------------|-------------------------------|---------------------------------------------------------------------------------------------------------------------------|--------------------------------|
| EP01         | Gestión de Cuenta              | Como usuario, quiero acceder a mi cuenta privada para gestionar mi perfil, actividades y colaboraciones dentro de la plataforma. | EP02, EP03                     |
| EP02         | Gestión de Perfil              | Como usuario, quiero actualizar mi perfil para asegurarme de que mi información personal y profesional esté actualizada.     | EP01                           |
| EP03         | Gestión de Contrataciones      | Como empresa o familiar, quiero contratar profesionales o influencers desde la plataforma para recibir servicios adecuados. | EP01, EP04                     |
| EP04         | Gestión de Pagos               | Como profesional de la salud o influencer, quiero controlar y gestionar los pagos recibidos por mis servicios en la plataforma. | EP03                           |
| EP05         | Gestión de Resultados Médicos  | Como usuario, quiero almacenar y acceder a los resultados de consultas médicas y chequeos realizados en el paciente.        | EP03                           |
...
|-------------------|----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| US01              | Acceso a la plataforma                       | Como usuario, quiero acceder de forma segura a mi cuenta privada, para gestionar mis actividades dentro de la plataforma.                         | 1. El usuario puede iniciar sesión utilizando credenciales válidas (correo electrónico y contraseña).<br>2. El sistema muestra una notificación en caso de intentos fallidos de inicio de sesión o de cuenta bloqueada. | EP01                   |
| US02              | Actualización de perfil                      | Como usuario, quiero actualizar mi perfil con mi información personal (nombre, dirección, especialidad, etc.), para asegurarme de que mis datos estén al día en la plataforma. | 1. El usuario puede modificar su nombre, dirección, especialidad y otros detalles personales desde la página de perfil.<br>2. El sistema notifica al usuario cuando los cambios en el perfil han sido guardados con éxito. | EP02                   |
| US03              | Contratar profesional de salud               | Como familiar de una persona con discapacidad, quiero contratar a un profesional desde la plataforma para recibir asistencia adecuada.            | 1. El usuario puede buscar y filtrar profesionales de la salud según la ubicación, especialidad y disponibilidad.<br>2. El sistema notifica al usuario cuando el profesional ha aceptado o rechazado la contratación. | EP03                   |
| US04              | Control de pagos                             | Como profesional de la salud, quiero registrar y visualizar mis pagos dentro de la plataforma para asegurarme de que recibo la compensación adecuada por mis servicios.  | 1. Los pagos recibidos y los pagos pendientes deben ser visibles en un panel de control de pagos para el profesional.<br>2. El sistema debe notificar al profesional cuando se realice un pago exitoso. | EP04                   |
| US05              | Registro de resultados de consultas           | Como usuario, quiero que todos los resultados de los chequeos médicos realizados en el paciente se almacenen en la plataforma, para poder tener un buen control y monitoreo de la salud del paciente. | 1. Los resultados de las consultas médicas deben archivarse automáticamente en el perfil del paciente.<br>2. El usuario recibe una notificación cuando se añaden nuevos resultados de chequeos o análisis. | EP05                   |
| US06              | Filtrado avanzado de influencers             | Como empresa usuaria de Connex, quiero poder filtrar influencers por criterios específicos como audiencia, sector, y ubicación, para asegurarme de que selecciono a los más adecuados para mi campaña. | 1. Los usuarios pueden aplicar al menos 4 filtros simultáneamente (demografía, ubicación, sector, nivel de influencia).<br>2. Los resultados se actualizan de forma dinámica cada vez que se ajustan los filtros. | EP01                   |
| US07              | Creación de portafolios personalizados por influencers | Como influencer en Connex, quiero crear y personalizar mi portafolio para mostrar mis métricas de rendimiento, para atraer a marcas relevantes. | 1. Los influencers pueden agregar y editar contenido en su portafolio y ver los cambios reflejados de manera inmediata.<br>2. El portafolio incluye al menos 3 métricas clave: alcance, engagement y demografía de la audiencia. | EP02                   |
| US08              | Gestión de acuerdos de colaboración          | Como empresa usuaria de Connex, quiero gestionar acuerdos de colaboración con influencers dentro de la plataforma, para mantener todo centralizado y organizado. | 1. Los acuerdos pueden ser creados, editados y almacenados en la plataforma.<br>2. Los términos clave del acuerdo (plazos, entregables, pagos) son visibles en una vista de resumen accesible. | EP01                   |
| US09              | Comunicación integrada entre empresas e influencers | Como usuario de Connex, quiero comunicarme directamente con influencers o empresas a través de la plataforma, para coordinar detalles de colaboración sin necesidad de utilizar herramientas externas. | 1. La plataforma incluye un sistema de mensajería interna con la capacidad de etiquetar conversaciones.<br>2. Las notificaciones automáticas alertan a los usuarios de nuevos mensajes en un plazo de 1 minuto. | EP01                   |
| US10              | Análisis de rendimiento de campañas          | Como empresa usuaria de Connex, quiero analizar el rendimiento de mis campañas de influencers dentro de la plataforma, para medir su efectividad y ajustar futuras estrategias. | 1. Los reportes incluyen métricas clave como alcance, engagement y conversión.<br>2. Los datos de rendimiento de las campañas se actualizan en tiempo real. | EP03                   |
